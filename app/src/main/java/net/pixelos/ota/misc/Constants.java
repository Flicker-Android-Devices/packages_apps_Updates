...
public final class Constants {
    ...
    static final String OTA_URL = "https://raw.githubusercontent.com/Flicker-Android-Devices/ota/%s/devices/%s.json";
    static final String MAINTAINER_URL = "https://github.com/%s";
    static final String DOWNLOAD_WEBPAGE_URL = "https://sourceforge.net/projects/flickerdev/files/PixelOS/fourteen/%s";
